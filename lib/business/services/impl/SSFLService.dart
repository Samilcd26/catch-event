...
class SSFLService extends ISSFLService {
  ...
  Future<http.Response> addCommentToEvent(int userId, int eventId, CommentModel comment) async {
    return await http.post(Uri.parse('$baseUrl/ssfl/addComment?userId=$userId&eventId=$eventId'), body: comment);
  }

  @override
  Future<http.Response> removeCommentToEvent(int userId, int eventId, int commentId) async {
    return await http.delete(Uri.parse('$baseUrl/ssfl/removeComment?userId=$userId&eventId=$eventId'));
  }
...
//! //////////////////////////////////////////////////////////////////
  ...
  Future<http.Response> addLikeToEvent(int userId, int eventId) async {
    return await http.get(Uri.parse('$baseUrl/ssfl/likeEvent?userId=$userId&eventId=$eventId'));
  }
...
//! //////////////////////////////////////////////////////////////////
  ...
  Future<http.Response> addDislikeToEvent(int userId, int eventId) async {
    return await http.get(Uri.parse('$baseUrl/ssfl/dislikeEvent?userId=$userId&eventId=$eventId'));
  }
...
//! //////////////////////////////////////////////////////////////////
  ...
  Future<http.Response> saveOrganizerEventToUserStore(int userId, int eventId) async {
    return await http.get(Uri.parse('$baseUrl/ssfl/saveEventStore?userId=$userId&eventId=$eventId'));
  }
