class GAddressModel {
  ...
  GAddressModel({this.results, this.status});

  GAddressModel.fromJson(Map<String, dynamic> json) {
...
class Geometry {
  ...
  Geometry.fromJson(Map<String, dynamic> json) {
    bounds = json['bounds'] != null ? new Bounds.fromJson(json['bounds']) : null;
    location = json['location'] != null ? new Northeast.fromJson(json['location']) : null;
    locationType = json['location_type'];
    viewport = json['viewport'] != null ? new Bounds.fromJson(json['viewport']) : null;
  }
...
class Bounds {
  ...
  Bounds.fromJson(Map<String, dynamic> json) {
    northeast = json['northeast'] != null ? new Northeast.fromJson(json['northeast']) : null;
    southwest = json['southwest'] != null ? new Northeast.fromJson(json['southwest']) : null;
  }
